...
<div class="fBody">
        <div class="cont">
            ...
            <p><?php 
                ...
                ?>   
                    <?php echo $dog ['DogStep2Desc1'] ?>
                <?php }else if ($data['genero']=="Hembra") {
                ?>
                    <?php echo $dog ['DogStep2Desc2']?>
                <?php } ?>   
            </p><br>
