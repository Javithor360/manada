...
<html>
    <head>
        ...
        <title>¡<?php echo $cat ['CatHeaderTitle'] ?> Darwin! ∙ La Manada</title>
    </head>
    <body>
        <div id="navy"></div>
<div class="fBody">
        <div class="cont">
            <h1 class="h1">¡<?php echo $cat ['CatHeaderTitle'] ?> Darwin!</h1>
            ...
            <p>
                ...
                no pierdas la oprtunidad, Es muy jugueton, le gusta que lo lleven a pasear  y que lo acaricien detras de las orejas.
            </p><br>
